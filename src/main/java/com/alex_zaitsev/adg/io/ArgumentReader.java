...
public class ArgumentReader {
	...
	public Arguments read() {
		String projectPath = null, resultPath = null, apkPath = null,
				filtersPath = null, packagePrefix = null;
		...
		return new Arguments(apkPath, projectPath, resultPath, filtersPath, packagePrefix);
	}
